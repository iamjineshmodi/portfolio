...
const Portfolio = () => {
    ...
    return (
        <div name="portfolio" className='bg-gradient-to-b from-gray-800 to-black w-full text-white py-20'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
                    {
                        portfolios.map(({ id, src, demo, code, title }) => (
                            <div key={id} className='shadow-md shadow-gray-600 rounded-lg overflow-hidden'>
                                <img src={src} alt="" className='rounded-md duration-200 hover:scale-105 h-40 w-full object-cover' />
                                <div className='flex justify-center items-center h-20 bg-gradient-to-br from-gray-800 to-gray-800'>
                                    <p className='text-xl mt-4 text-center px-2'>{title}</p>
                                </div>
                                <div className='flex justify-between items-center'>
                                    <a href={demo} target='_blank' rel="noopener noreferrer" className='w-1/2 px-10 p-4 duration-200 hover:scale-110 hover:bg-gradient-to-r from-gray-800 to-blue-500 text-center shadow-sm shadow-white' >
                                        Demo
                                    </a>

                                    <a href={code} target='_blank' rel="noopener noreferrer" className='w-1/2 px-10 p-4 duration-200 hover:scale-110 hover:bg-gradient-to-r to-gray-800 from-red-500 text-center shadow-sm shadow-white'>
                                        Code
                                    </a>
                                </div>
                            </div>
